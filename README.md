...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-25 15:51`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7e4a16fb-c180-4acd-8ac7-d0b74e8bed6a.git
$ cd 7e4a16fb-c180-4acd-8ac7-d0b74e8bed6a
```
